  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-20 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Pressure Washing paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Ready to refresh your driveway, siding, patio, or storefront? Our team delivers deep-cleaning pressure washing services to restore surfaces and boost curb appeal—quickly and professionally.
              <br /><br />
              Fill out the form to request your free estimate. We&apos;ll follow up shortly to learn more about your space and get your project on the schedule.
            </p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <select id="service" name="service" required className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 outline-gray-300 focus:outline-blue-400">
                  ...
                  <option value="residential-commercial-lawncare">Residential + Commercial Lawncare</option>
