...
export default function MovingHaulingContact() {
  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-36 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Moving/Hauling-focused paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Request a Free Moving, Hauling, or Recycling Estimate
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Whether you&apos;re planning a move, clearing out old furniture, or looking for help with junk removal and recycling — we&apos;ve got you covered. Our team provides fast, reliable moving and hauling services for residential and commercial properties throughout Savannah.
              <br /><br />
              Fill out the form below to request your free estimate. We&apos;ll be in touch shortly to learn more about your needs and schedule your service.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm mx-auto lg:max-w-md bg-white text-gray-900 p-8 mt-12 lg:ml-12 rounded-lg shadow-lg">
          {state.succeeded ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <h2 className="text-2xl font-bold text-gray-900 text-left mb-6">Schedule Your Free Painting Estimate</h2>
