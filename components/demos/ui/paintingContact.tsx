        ...
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Looking to refresh your home or business with a new coat of paint? We offer professional interior and exterior painting services designed to improve curb appeal, protect your property, and give your space a clean, polished look.
              <br /><br />
              Fill out the form to schedule your free painting consultation. Our team will follow up shortly to learn more about your project and help you get started.
            </p>
          </div>
        </div>
