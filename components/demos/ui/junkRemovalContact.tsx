...
export default function JunkRemovalContact() {
  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-20 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Junk Removal-focused paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Book a Junk Removal Estimate
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Whether you&apos;re clearing out a garage, managing a move, or cleaning up after a renovation, we&apos;re here to help. Our team handles junk, debris, old furniture, and unwanted items with care — hauling it away quickly and responsibly so you don&apos;t have to.
              <br /><br />
              Fill out the form to request your free junk removal quote. We&apos;ll follow up soon to learn about your space and schedule a convenient pickup time.
            </p>
          </div>
        </div>
