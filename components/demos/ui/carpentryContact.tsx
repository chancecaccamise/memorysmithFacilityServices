  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-20 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Carpentry-focused paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Request a Carpentry or Handyman Estimate
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              Whether it&apos;s a quick fix or a custom carpentry project, we&apos;re here to help bring your vision to life. From built-ins and shelving to trim, doors, and general repairs, our skilled team provides reliable service and quality results.
              <br /><br />
