...
export default function CleaningContact() {
  ...
  return (
    <div id="contact" className="relative isolate bg-gray-50 pt-20 pb-20 scroll-mt-36 min-h-screen">
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        {/* Left Column: Cleaning-focused paragraph */}
        <div className="relative px-6 pt-8 pb-20 lg:static lg:px-8 lg:py-24">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
              Book a Professional Cleaning Estimate
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              From residential homes and offices to Airbnb turnovers, our cleaning services are built for reliability, speed, and detailed results. We&apos;ve cleaned over 30 short-term rentals and know how to make any space feel fresh and guest-ready.
              <br /><br />
              Fill out the form to request a free estimate. We&apos;ll reach out shortly to learn more about your space and how we can help.
            </p>
          </div>
        </div>
